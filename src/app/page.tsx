...
export default function Page() {
  ...
  return (
    <div className="min-h-screen">
      <div className="bg-[#1a1f36] bg-cover bg-center" style={{ backgroundImage: "url('/background.png')" }}>
        <div className="max-w-4xl mx-auto w-full flex justify-between items-center sticky top-0 z-50 bg-[#1a1f36]">
          <MainNav />
          <div className="flex items-center gap-2">
            <Link 
              href="/passengerrights"
              className="inline-flex items-center justify-center rounded-md text-sm font-medium 
                hover:bg-white/20 h-9 px-3 transition-colors text-white"
              aria-label="Passenger Rights"
            >
              Passenger Rights
            </Link>
            <a 
